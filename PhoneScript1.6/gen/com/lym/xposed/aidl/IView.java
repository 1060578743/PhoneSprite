 ...
 * Original file: C:\\Users\\980008027\\workspace\\PhoneScript\\src\\com\\lym\\xposed\\aidl\\IView.aidl
 */
...
case TRANSACTION_selectRes:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
com.lym.xposed.aidl.IView _result = this.selectRes(_arg0);
reply.writeNoException();
reply.writeStrongBinder((((_result!=null))?(_result.asBinder()):(null)));
return true;
}
...
@Override public com.lym.xposed.aidl.IView selectRes(java.lang.String res) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.lym.xposed.aidl.IView _result;
...
mRemote.transact(Stub.TRANSACTION_selectRes, _data, _reply, 0);
_reply.readException();
_result = com.lym.xposed.aidl.IView.Stub.asInterface(_reply.readStrongBinder());
}
finally {
...
static final int TRANSACTION_selectRes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_parent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_exist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_isVisible = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_getText = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getWidth = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_getHeight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getX = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getY = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getChildCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_setText = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_click = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_longClick = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_scroll = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
}
...
public com.lym.xposed.aidl.IView selectRes(java.lang.String res) throws android.os.RemoteException;
